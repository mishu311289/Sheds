...
@property (retain, nonatomic) TKCalendarMonthView *calendar;
...
@property (strong, nonatomic) IBOutlet UILabel *daysappliedlbl;
...
@property (strong, nonatomic) NSString *masteredstr ,*shedType, *sortingStr;
@property (assign, nonatomic) int totaldaysSelected;
@property ( assign) int flag,flags;
